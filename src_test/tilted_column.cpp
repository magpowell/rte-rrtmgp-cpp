                 ...
                 std::vector<Float>& zh_tilted)
{
    ...
    for (int iz=0; iz<dz_tilted.size(); ++iz)
        zh_tilted.push_back(zh_tilted.back()+dz_tilted[iz]);
}

void create_tilted_columns(const int n_x, const int n_y, const int n_lay_in, const int n_lev_in, const std::vector<Float>& zh_tilted, 
